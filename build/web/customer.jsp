...
<html lang="en">
    ...
    <body>
        ...
        <form action = "MainController" method="post">
            <p>First Name:</p><input type="text" name="fName" value="<%=user.getFirstName()%>" required>
            <p>Last Name:</p><input type="text" name="lName" value="<%=user.getLastName()%>" required>
            <p>Phone:</p><input type="tel" name="phone" value="<%=user.getPhone()%>" required>
            <p>Email:</p><input type="email" name="email" value="<%=user.getEmail()%>" disabled>
            <p style="color: green;">${mess1}</p>
            <p style="color: red;">${error1}</p>
            </br><input type="submit" name="action" value="Change Account Details">
        ...
        <form action = "MainController" method="post">
            ...
            <p>Confirm Password:</p><input type="password" name="cpassword" required>
            <p style="color: green;">${mess2}</p>
            <p style="color: red;">${error2}</p>
            </br><input type="submit" name="action" value="Change Password">
            <input type="reset" value="Cancel">
        </form>

        <h3>Address</h3>
        <form action = "MainController" method="post">
            <p>Country:</p><input type="text" name="country" value="<%=user.getCountry()%>" disabled>
            <p>Street Address:</p><input type="text" name="streetAddress" value="<%=user.getStreetAddress()%>" required>
            <p>Company Name:</p><input type="text" name="companyName" value="<%=user.getCompanyName()%>">
            <p>Apartment:</p><input type="text" name="apartment" value="<%=user.getApartment()%>">
            <p>City:</p><input type="text" name="city" value="<%=user.getCity()%>" required>
            <p>Postcode:</p><input type="text" name="postcode" value="<%=user.getPostcode()%>" required>
            <p style="color: green;">${mess3}</p>
            <p style="color: red;">${error3}</p>
            </br><input type="submit" name="action" value="Change Address">
            <input type="reset" value="Cancel">
        </form>
