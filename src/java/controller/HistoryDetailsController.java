...
public class HistoryDetailsController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        OrderDTO order = new OrderDAO().getOderByOrderID(oID);
        List<OrderItemsDTO> listoi = new OrderItemsDAO().getOrderItemsByOrderID(oID);

        request.setAttribute("order", order);
        request.setAttribute("listoi", listoi);
